...
from ontological_robot_control.msg import PlanFeedback, PlanResult
from ontological_robot_control.srv import GetPose
...
class PlaningAction(object):
    ...
    def __init__(self):
        ...
        self._as = SimpleActionServer(anm.ACTION_PLANNER, 
                                      ontological_robot_control.msg.PlanAction, 
